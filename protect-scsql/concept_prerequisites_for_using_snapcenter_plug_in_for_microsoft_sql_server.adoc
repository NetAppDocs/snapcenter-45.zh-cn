...
+
有关运行 cmdlet 的信息，请参见 https://library.netapp.com/ecm/ecm_download_file/ECMLP2877143["《 SnapCenter 软件 cmdlet 参考指南》"]
...
* 将现有数据库移动到 NetApp 存储上。
+
有关详细信息，请参见 SnapCenter 导入信息。

+
link:concept_import_archived_backups_from_snapmanager_for_sql_to_snapcenter.html["将归档备份从 SnapManager for Microsoft SQL Server 导入到 SnapCenter"]
